...
public class textureParams {
	...
	public void loadTexture(GL3 gl3) {
		try {
			// Loading smiley and frowny image files using input stream.
			InputStream inputStream1 = new FileInputStream("smiley2.png");
			InputStream inputStream2 = new FileInputStream( "frowny2.png" );
