...
public class lightingParams {
	...
	public void setUpPhong(int program, GL3 gl3) {
		...
		gl3.glUniform4f(gl3.glGetUniformLocation(program, "light_Source_Color"), 1.0f, 1.0f, 0.0f, 1.0f);

		// Setting up light source position.
		gl3.glUniform4f(gl3.glGetUniformLocation(program, "light_Source_Position"), 0.0f, 5.0f, 2.0f, 1.0f);
